            ...
            <div className="flex items-center space-x-4">
              <div className="w-full bg-slate-200 rounded-full h-2 max-w-48">
                <div
                  ...
                  style={{
                    width: `${Math.min(100, (trialDaysLeft / 182) * 100)}%`,
                  }}
                ></div>
              </div>
            ...
            {savedSearches.length === 0 ? (
              <Card>
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-slate-600 mb-4">
                    Create your first saved search to get alerts when new
                    matching vehicles are available.
                  </p>
                  ...
                  >
                      ...
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex space-x-2">
                          <Button
                            ...
                            variant="ghost"
                            onClick={() =>
                              runSavedSearchMutation.mutate(search.id)
                            }
                    ...
                    <CardContent>
                      ...
                      <div className="flex justify-between items-center">
                        <Badge
                          variant={
                            search.alertsEnabled ? "default" : "secondary"
                          }
                        >
            ...
            {favorites.length === 0 ? (
              <Card>
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-slate-600 mb-4">
                    Save vehicles you're interested in to keep track of them.
                  </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {favorites.map((vehicle: any) => (
                  <VehicleCard
                    ...
                    isFavorite={true}
                    onRemoveFavorite={() =>
                      removeFavoriteMutation.mutate(vehicle.id)
                    }
                  />
                ))}
              </div>
